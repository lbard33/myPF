			...
			<article id="content">
				<dl class="main">
					<dt class="descTitle">
						...
						<i>2020.07.06</i>
						<em>다비는 헤이즈의 1위 곡을 쏟아낸 프로듀서이자 재즈 알앤비 뮤지션이다. ‘당신의 물음에 답이 되어주고 싶어서’ 다비라 이름 지었다.</em>
					</dt>
					<dd class="mainImg">
						<p class="imgArea"><img src="../img/desc/desc03_00.jpg" alt="desc 메인 이미지"/></p>
						<p class="textArea">
					...
					<dd class="sideDesc">
						<p class="sideImg"><img src="../img/desc/desc03_01.jpg" alt="desc 사이드 이미지"/></p>
						<div>
							<p class="sideText">셔츠와 팬츠는 지방시(Givenchy), 목걸이는 무궁화랑(Mugoonghwarang).</p>
							<div class="credit">
								<h4>CREDIT</h4>
								<p>피처 에디터 김나랑</p>
								<p>포토그래퍼 이윤화</p>
