...
<html lang="ko">
  ...
  <script>
		...
		function IDchkBtns(){
			...
			if (email.value=="")
			{
				...
				xmlhttp.open("GET","idDouble.php?q="+email.value, true);
 ...
 <body>
	<div id="wrap">
		<div id="header">
			<h1><a href="index.html" title="VOGUE 메인 사이트"><img src="img/vogue_logo.png" alt="VOGUE"/></a></h1>
			<div id="hiddenMenu">
				<div class="hiddenLogo">
					<a href="index.html" title="vogue">
				...
				<div class="mainH">
					<ul>
						...
						<li><a href="beauty.html" title="beauty">beauty</a></li>
						<li><a href="living.html" title="living">living</a></li>
						<li><a href="people.html" title="people">people</a></li>
						<li><a href="runway.html" title="runway">runway</a></li>
						<li><a href="subscribe.html" title="subscribe">subscribe</a></li>
					</ul>
				</div>
				<div class="sideH">
					<ul class="sns">
					...
					<dl>
						<dt>company</dt>
						<dd><a href="company.html" title="회사소개">회사소개</a></dd>
						<dd><a href="advertising.html" title="광고 및 제휴">광고 및 제휴</a></dd>
						<dd><a href="policy.html" title="개인정보 처리방침">개인정보 처리방침</a></dd>
					</dl>
					<p class="red"><a href="login.html" title="login">Login</a></p>
					<p><a href="sign_up.html" title="sign_up">Sign up</a></p>
				</div>
			</div>
			<div id="header_inner">
				<div id="gnb">				
					...
					<ul class="sideMenu">
						<li>
							...
							<ol class="company">
								...
								<li><a href="advertising.html" title="광고 및 제휴">광고 및 제휴</a></li>
								<li><a href="policy.html" title="개인정보 처리방침">개인정보 처리방침</a></li>
							</ol>
						</li>
						<li>|</li>
						<li class="login"><a href="login.html" title="login">Login</a></li>	
					</ul>
		...
		<div id="container">
			<div class="title">
				...
				<div class="step">
					<p>01 약관동의 &gt;</p>
					<p class="sctS">02 정보입력 &gt;</p>
					<p>03 가입완료</p>
				</div>
			</div>
			<form action="sign_up_control.php" method="post">
				<fieldset>
					<legend class="le">기본정보</legend>
					<p class="re"><span class="red">+</span> 표시는 반드시 입력하셔야 하는 항목입니다.</p>
					<ul>
						<li>
							<label for="email"><span class="red">+</span> 아이디 (email)</label><input id="email" type="email" name="email" placeholder="example@domain.com" required="required" autocomplete="off"/>
							<input id="IDchkBtn" type="button" value="중복체크" onclick="IDchkBtns();"/>&nbsp;&nbsp;<span id="IDchkDesc">※ 아이디 중복체크</span>
						</li>
						<li>
							<label for="userpw"><span class="red">+</span> 비밀번호</label><input id="userpw" type="password" name="userpw" placeholder="숫자+영문 8~20자" maxlength="20" minlength="8" required/>
						</li>
						<li>
							<label for="userpwChk"><span class="red">+</span> 비밀번호 확인</label><input id="userpwChk" type="password" name="userpwChk" maxlength="20" minlength="8" required/>
						</li>
						<li>
							<label for="username"><span class="red">+</span> 이름</label><input id="username" type="text" name="username" required autocomplete="off"/>
						</li>
						<li>
							<label for="phone"><span class="red">+</span> 휴대폰 번호</label><input id="phone" type="tel" name="phone" placeholder='- 없이 입력하세요.' maxlength="11" required autocomplete="off"/>
				...
				<div>
					<input id="cancel" type="reset" value="다시쓰기"/>
					<input id="sign" type="submit" value="회원가입" onclick="check();"/>
				</div>
			</form>
		</div>
		<footer id="footer">
			<p class="footer_logoV vogue">
				<a href="index.html" title="vogue"><img src="img/vogue_footer_logo.png" alt="풋터 로고"/></a>
			</p>
		</footer>
	</div>
 </body>
