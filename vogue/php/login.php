...
<html lang="ko">
 ...
 <body>
	<div id="wrap">
		<div id="header">
			...
			<div id="hiddenMenu">
				...
				<div class="sideH">
					...
					<p><a href="agreement.html" title="sign_up">Sign up</a></p>
				</div>
			</div>
			<div id="header_inner">
				<div id="gnb">
		...
		<div id="container">
			<div id="content">
				...
				<form id="loginArea" action="login_control.php" method="post">
					...
					<div id="signupArea">
						<p><a href="agreement.html" title="회원가입">회원가입</a></p>|
		...
		<div id="footer">
			<div id="mainFooter">
				<p class="footer_logo"><a href="index.html" title="메인"><img src="img/vogue_footer_logo.png" alt="풋터 로고"/></a></p>
				<p class="copy">VOGUE&copy;EthanLee All Rights Reserved. lbard@naver.com</p>
				<p class="legal"><a href="policy.html" title="개인정보 취급방침">개인정보 취급방침</a></p>
			</div>
		</div>
	</div>
 </body>
