 ...
 <head>
  ...
  <style>
    ...
    /*################### container ###############################*/
		...
		legend{display:none;}
		/*######## form 부분 #########*/
		fieldset{width:500px; height:180px; margin:50px auto 0; padding-top:50px; border:none;}
		p{height:40px;}
		label{width:170px; padding-left:50px; display:block; float:left; height:30px; line-height:30px; text-align:center;}
		input{display:block; float:left; height:30px; width:250px; text-indent:10px;}
		#useremail{border:none; cursor:default; outline:none;}

		p:after{content:""; display:block; clear:both;}


		.btnArea{width:400px; height:70px; margin:0 auto;}
		.btnArea p{width:150px; height:40px; float:left; margin-left:40px; text-align:center;}
		.btnArea input{width:100%; height:100%; text-indent:0;}
		input[type="submit"]{background-color:#a00; color:#fff; font-weight:700;}
  ...
  <script>
		...
		//############# 히든 메뉴 ###############
			...
			$("#hiddenMenu .closeBtn").click(function(){
				$("#wrap").css({"height":"0","overflow":"visible"});
		...
		function chkpw(){
			var pw=document.getElementById("userpw0");
			var pwChk=document.getElementById("userpw00");
...
<?php }?>
		...
		<div id="container">
			...
			<form action="chkpass_control.php" method="post">
				<fieldset>
					<legend>비밀번호 입력</legend>
					<p><label for="useremail">아이디  :</label><input id="useremail" type="text" name="useremail" value="<?=$_SESSION['useremail']?>" readonly required/></p>
					<p><label for="userpw">현재 비밀번호  :</label><input id="userpw" type="password" name="userpw" placeholder="8~20자" maxlength="20" minlength="8" required /></p>
					<p><label for="userpw0">새로운 비밀번호  :</label><input id="userpw0" type="password" name="userpw0" placeholder="8~20자" maxlength="20" minlength="8" required /></p>
					<p><label for="userpw00">새로운 비밀번호 확인  :</label><input id="userpw00" type="password" name="userpw00" placeholder="8~20자" maxlength="20" minlength="8" required /></p>
				</fieldset>
				<div class="btnArea">
					<p><input type="submit" value="확인" title="확인" onclick="chkpw();"/></p>
					<p><input id="ret" type="button" value="이전으로" title="이전으로" onclick="retBtn();"/></p>
				</div>
			</form>
		</div>
		<footer id="footer">
