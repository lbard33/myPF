 ...
 <head>
  ...
  <style>
    ...
    /*################### container ###############################*/
		...
		.btnArea{width:500px; height:150px; margin:50px auto 0;}
		.btnArea p{width:300px; margin:20px auto 0; height:60px; background-color:#700; text-align:center; line-height:60px; font-weight:700; border:2px solid #555; box-shadow:3px 3px 5px rgba(0,0,0,0.5); border-radius:20px; cursor:}
		.btnArea p a{color:#fff; width:100%; height:100%; display:block;}
		

		.btnArea p:hover{background-color:#333; border:2px solid #f00;}
 ...
 <body>
	<div id="wrap">
			...
			<div id="header_inner">
				...
				<div id="lnb">
					...
					<ul class="sideMenu">
						...
						<li><a href="member.php" title="개인설정" style="color:hotpink; font-size:16px; font-weight:700;"><?=$_SESSION['username']?></a><span style="font-weight:700; color:#000;">님  접속</span>&nbsp;&nbsp;&nbsp;<a href="logout.php" title="로그아웃" style="font-size:14px; color:red; font-weight:700;">&lt;LOGOUT&gt;</a></li>
					</ul>
		...
		<div id="container">
			...
			<div class="btnArea">
				<p><a href="memberEdit.php" title="개인정보 수정">개인정보 변경</a></p>
				<p><a href="chkPass.php" title="비밀번호 변경">비밀번호 변경</a></p>
			</div>
		</div>
		<footer id="footer">
